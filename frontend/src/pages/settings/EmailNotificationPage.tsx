      ...
      <div className="px-6 py-4 border-b border-dark-100 bg-dark-300 sticky top-0 z-10">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-semibold text-white">邮件通知</h1>
      ...
      <div className="p-6">
        ...
        <div className="bg-dark-300 border border-dark-100 rounded-xl p-6">
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-white">新消息通知</div>
                <div className="text-xs text-gray-500">收到新消息时发送邮件通知</div>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <div className="text-white">系统更新通知</div>
                <div className="text-xs text-gray-500">系统更新和重要公告</div>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
            ...
            <div className="flex items-center justify-between">
              <div>
                <div className="text-white">每周摘要</div>
                <div className="text-xs text-gray-500">每周接收活动摘要邮件</div>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
