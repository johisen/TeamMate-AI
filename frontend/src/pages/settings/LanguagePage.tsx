...
export const LanguagePage: React.FC = () => {
  ...
  const languages = [
    ...
    { value: 'en-US', label: 'English', description: 'English (US)' },
      ...
      <div className="px-6 py-4 border-b border-dark-100 bg-dark-300 sticky top-0 z-10">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-semibold text-white">语言</h1>
          ...
          <div className="space-y-4">
            {languages.map((language) => (
              <div
                ...
                className={`p-4 rounded-lg border cursor-pointer transition-all ${selectedLanguage === language.value ? 'bg-primary-600/20 border-primary-500' : 'bg-dark-200 border-dark-100 hover:border-primary-500/50'}`}
              >
                <div className="flex items-center justify-between">
                  <div>
